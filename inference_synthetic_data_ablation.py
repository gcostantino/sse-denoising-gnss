...
if __name__ == '__main__':
    ...
    weight_path = os.path.join(os.path.expandvars(work_directory),
                               'weights/best_cascadia_18Feb2024-194144_train_denois_realgaps_v5_ablation_spatial_att_only.pt')

    # best_cascadia_18Feb2024-193603_train_denois_realgaps_v5_ablation_notransf.pt
    # best_cascadia_18Feb2024-194215_train_denois_realgaps_v5_ablation_temp_att_only.pt
    ...
    dataset_path = os.path.expandvars(work_directory) + '/pred_denoising_test_data' + ablation_str
    data_dict = dict()
    data_dict['pred'] = pred
